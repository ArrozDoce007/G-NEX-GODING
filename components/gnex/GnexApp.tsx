  ...
  return (
    <div className="relative min-h-screen bg-transparent selection:bg-brand-purple selection:text-white overflow-x-hidden transition-colors duration-500">
      ...
      <div className="relative z-10">
        ...
        <footer className={`py-12 sm:py-16 md:py-20 border-t border-slate-200 dark:border-white/5 bg-white/40 dark:bg-black/40 backdrop-blur-2xl transition-colors duration-500 ${!activeProject ? 'pb-24 lg:pb-20' : ''}`}>
