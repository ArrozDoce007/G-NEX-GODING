    ...
    <main className="bg-transparent">
      ...
      <section className="py-8 sm:py-10 md:py-12 overflow-hidden" id="showcase">
        <div className="container mx-auto px-4 sm:px-6 mb-6 sm:mb-8">
          <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
            ...
            <span className="text-[10px] sm:text-xs font-mono font-bold text-brand-purple uppercase tracking-[0.2em] sm:tracking-[0.3em]">Showcase Elite</span>
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold text-slate-900 dark:text-white tracking-tighter">
            Projetos em <br className="sm:hidden" />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-purple to-violet-400">Destaque</span>
          </h2>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6 mb-8 sm:mb-10 md:mb-12">
            <div className="space-y-2 sm:space-y-3">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white tracking-tight transition-colors duration-500 text-shadow-sm">Todos os Cases</h2>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-black/[0.02] dark:bg-black/40 backdrop-blur-2xl border-y border-black/5 dark:border-white/10 transition-colors duration-500 scroll-mt-24" id="methodology">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold mb-8 sm:mb-10 md:mb-12 text-slate-900 dark:text-white tracking-tight transition-colors duration-500 uppercase tracking-widest">Metodologia de Entrega Elite</h2>
