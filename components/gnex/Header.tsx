...
import { Sun, Moon, Home, Briefcase, FolderOpen, Lightbulb, ChevronDown } from 'lucide-react';
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="relative" ref={langRef}>
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-3 h-3 text-slate-500 dark:text-slate-400 transition-transform duration-300 ${langOpen ? 'rotate-180' : ''
                      }`}
                  />
                </motion.button>
                    ...
                    >
                      {LANGUAGES.map((language) => (
                        <button
                          ...
                          className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm font-medium transition-colors duration-200 ${lang === language.code
                            ? 'text-brand-purple bg-brand-purple/10'
